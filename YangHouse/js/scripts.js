$(document).ready(function () {
    ...
    $(function () {
        $(window).scroll(function () {
            ...
            if (scroll >= 20) {
                ...
                $('header').css({
                    "border-bottom": "solid 1px rgba(210, 177, 172, 0.88)",
                    "padding": "50px 0"
                });
                $('header .member-actions').css({
                    "top": "41px",
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        // } else {
            $.post('https://script.google.com/macros/s/AKfycbxoLGwblsvwMYc9xV21K6M5XVXJYccrnoWyZYRpvP1DoutL59WjSjvhiLz6oQr3qAAj/exec', data)
                .done(function (data) {
                    console.log(data);
...
// Google map
function initMap() {
    var location = {lat: 37.263351199113956, lng: -121.83339318050838};
...
function initBBSRMap() {
    var la_fiesta = {lat: 37.263351199113956, lng: -121.83339318050838};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
